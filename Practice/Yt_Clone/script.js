...
function searchIconAppear(){
    document.getElementById("iconBeforeSearch").style.width = "24px";
}

function searchIconDisappear() {
    document.getElementById("iconBeforeSearch").style.width = "0";
};

function suggestionsDisappear(){
